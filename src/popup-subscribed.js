...
const API_KEY = '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';
...
export default function PopupSubscribed() {
  ...
  Smodal.querySelector('form#THANKS_SUBSCRIBE_FORM').addEventListener('submit', async function(e) {
    ...
    try {
      const result = await S.addContact(email, name, [7], cname); // [7] list ids number of sendinblue
      console.log(result);
    } catch (e) {
      console.log(e);
    }
