...
const THANKS_MESSAGE = window.__thanks_message ? window.__thanks_message : `Thanks! Your friend's gift is on its way`;
...
export default function PopupSubscribed() {
  ...
  Smodal.querySelector('form#THANKS_SUBSCRIBE_FORM').addEventListener('submit', async function(e) {
    ...
    thankMessage.innerHTML = `<div class="s-modal__message"><p>${ THANKS_MESSAGE }</p></div>`;
